...
const CarouselPrevious = ({ className }: { className?: string }) => {
  ...
  return (
    <ArrowButton
      ...
      className={cn(
        "absolute lg:block hidden",
        orientation === "horizontal"
          ? "top-1/2 -left-20 -translate-y-1/2"
          : "-top-12 left-1/2 -translate-x-1/2 rotate-90",
        !canScrollPrev ? "cursor-auto" : "cursor-pointer",
        className
      )}
      onClick={scrollPrev}
    >
      <ChevronLeft size={90} color={!canScrollPrev ? "gray" : "white"} />
  ...
  return (
    <ArrowButton
      ...
      className={cn(
        ...
        !canScrollNext ? "cursor-auto" : "cursor-pointer",
        className
      )}
      onClick={scrollNext}
    >
      <ChevronRight size={90} color={!canScrollNext ? "gray" : "white"} />
